...
class SettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'table_count' => ['required', 'integer', 'min:0', 'max:200'],
    ...
    public function messages(): array
    {
        return [
            ...
            'table_count.required' => 'Masukkan bilangan meja.',
            'table_count.integer' => 'Bilangan meja mesti nombor bulat.',
            'table_count.min' => 'Bilangan meja tidak boleh negatif.',
            'table_count.max' => 'Bilangan meja maksimum 200.',
