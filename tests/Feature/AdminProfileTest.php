...
class AdminProfileTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->admin = User::factory()->create(['is_admin' => true, 'approved_at' => now(), 'password' => 'kata-laluan-lama']);
    }
    ...
    public function test_admin_can_change_their_own_password_with_the_correct_current_password(): void
    {
        $this->actingAs($this->admin)
